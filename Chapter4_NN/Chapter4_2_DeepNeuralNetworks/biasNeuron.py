...
def plot_function(
        ...
        name: str = None) -> None:
    plt.step(input_signal, output_signal_neg, color="blue", label="Bias: -2")
    plt.step(input_signal, output_signal, color="black", label="Bias: 0")
    plt.step(input_signal, output_signal_pos, color="red", label="Bias: 2")
    plt.xlabel("a")
    plt.ylabel("f(a)")
